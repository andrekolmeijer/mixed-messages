...
function formatDocument() {
  ...
  small.innerHTML = 'Runs a script <span>modified</span> for the browser. The original script can be viewed in action in the <a href="#">browser console</a>.';
  small2.innerHTML = 'Want to learn more? Visit the <a href="#">GitHub repo</a> for more details.';
  ...
  paragraph2.innerHTML = 'Learn how the color changes by checking out the <a href="#">source code</a>.';
