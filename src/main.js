...
function formatDocument() {
  ...
  const a2 = createElementHelper('a', 'href', '#');
  const ul2 = createElementHelper('ul', 'id', 'ul2');
  const li2 = createElementHelper('li', 'id', 'li2');
  const a3 = createElementHelper('a', 'href', '#', 'title', 'GitHub repository');
  const container = createElementHelper('div', 'id', 'container');
  const backdrop = createElementHelper('div', 'id', 'backdrop');
  const main = createElementHelper('main');
  const section = createElementHelper('section', 'id', 'section-one');
  const div3 = createElementHelper('div', 'id', 'div3');
  const heading = createElementHelper('h1');
  const paragraph = createElementHelper('p');
  const div4 = createElementHelper('div', 'id', 'div4');
  const button = createElementHelper('a', 'id', 'button', 'type', 'button');
  const small = createElementHelper('small');
  ...
  small.innerHTML = 'Runs a script <strong>modified</strong> for the browser. The original script can be viewed in action in the <a href="#">browser console</a>.';
  small2.innerHTML = 'Want to learn more? Visit the <strong><a href="#">GitHub</a></strong> repository.';
  ...
  paragraph2.innerHTML = 'Learn how the colors change by <a href="#">viewing the script on GitHub</a>.';
  a4.innerHTML = '<span>Design from Node.js website</span><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" data-slot="icon" class="NavItem_icon__GHTPH"><path fill-rule="evenodd" d="M8.25 3.75H19.5a.75.75 0 0 1 .75.75v11.25a.75.75 0 0 1-1.5 0V6.31L5.03 20.03a.75.75 0 0 1-1.06-1.06L17.69 5.25H8.25a.75.75 0 0 1 0-1.5Z" clip-rule="evenodd"></path></svg>';
  a5.innerHTML = '<span>&copy; André Kolmeijer</span>';
